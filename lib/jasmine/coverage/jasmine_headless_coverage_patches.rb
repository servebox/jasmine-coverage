...
module Jasmine::Headless
  class TemplateWriter
    ...
    def write
      ...
      test_rigfolder = Jasmine::Coverage::Config.output_dir+"/test-rig"
      ...
      FileUtils.copy_entry("#{Jasmine::Coverage::Config.output_dir}/../fixtures", "#{test_rigfolder}/target/fixtures") rescue nil
      ...
      #FileUtils.copy_entry("#{Jasmine::Coverage::Config.output_dir}/../../spec", "#{test_rigfolder}/spec")
      FileUtils.copy_entry("#{Jasmine::Coverage::Config.output_dir}/../../app", "#{test_rigfolder}/app")
  ...
  class FilesList
    ...
    def to_html(files)
      ...
      (old_to_html files).each do |path|
        files_map = Jasmine::Coverage::Config.resources
